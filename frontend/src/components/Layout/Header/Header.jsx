    ...
    <header>
      <div className="global-notification">
        <div className="container">
          <p>
          MOTORUN KALBİ İÇİN EN İYİ BAKIM! FİLTRELERİMİZDE YENİ DÖNEM. <a href="shop.html"> ŞİMDİ ALIŞVERİŞ YAPIN</a>
          </p>
        </div>
      </div>
                        ...
                        <div className="megamenu-links">
                          <div className="megamenu-products">
                            ...
                            <ul className="megamenu-menu-list">
                              <li>
                                <a href="#">Hava Filtresi</a>
                              </li>
                              <li>
                                <a href="#">Yağ Filtresi</a>
                              </li>
                              <li>
                                <a href="#">Polen Filtresi</a>
                              </li>
